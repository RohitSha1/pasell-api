...
const { createUsers,getuserid } = require('../Controller/Register');
...
const { AddhomeCarousel, addCategoryStatic, addProductsStatic, updateCategory,deleteProduct, updateProduct, deleteCategory, addCategory,getProduct, addProduct, getCategoryById, getproductid } = require('../Controller/StaticDataController');
...
router.get('/api/getproductid/:id',getproductid);
router.get('/api/getuserid/:id',getuserid);
...
router.get('/api/get-products-for-categories/:id',getProductsForCategories );
